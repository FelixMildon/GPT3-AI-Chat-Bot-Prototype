...
export default async function handler(req: any, res: any) {
  ...
  const defaultPrompt = `I am a doctor and I will make a medical diagnosis, I will not recommend my patient to seek medical attention or to see another doctor . \n\nThis is the conversation between a doctor and a sick person.\n\n${botName}: ${firstMessge}\n${userName}: ${messagesPrompt}\n${botName}: `
