...
const userName = 'Sick person' // TODO: move to ENV var
...
export default async function handler(req: any, res: any) {
  ...
  const defaultPrompt = `I am a doctor and I will ask questions to make a medical diagnosis, I will not recommend my patient to seek medical attention and I will not recommend see another doctor and I will not recommend to call for help and I will not recommend to go to a emergancy room. \n\nThis is the conversation between a doctor and a sick person.\n\n${botName}: ${firstMessge}\n${userName}: ${messagesPrompt}\n${botName}: `
